...
export async function registerUser(req, res) {
    ...
    try {
        ...
        const user = await organizationModel.create({ name, password, confirmPassword, email, organisationName, organisationUrl, displayName, phoneNumber, whatsappNumber, allowNotifications, preferredLanguage, country, organisationID: `EA${generatedInstructorCode}` });
